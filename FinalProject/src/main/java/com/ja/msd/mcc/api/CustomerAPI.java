...
import com.ja.msd.mcc.repository.CustomersRepository;
	...
	public ResponseEntity<?> lookupCustomerByNameGet(@PathVariable("username") String username,
		...
		for (Customer c:repo.findAll())
		{
			if (c.getName().equalsIgnoreCase(username) )
			{
				...
				URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{username}").buildAndExpand(c.getName()).toUri();
